...
exports.menu = (botname, pushname) => {
	return`Hi Kak ${pushname} 🐦

I am ${botname}, This bot is Beta Multi-Device WhatsApp.
If you find some kind of bug or error, please understand first, please report it to Owner In order to be repaired immediately 🙏`
}

// List
exports.list = (pushname) => {
	return`Hai kak ${pushname}👋, Please select the menu list below 🐦`
}
